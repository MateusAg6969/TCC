...
└─────────────────────────────────────────────────────────────────────────────┘
    ...
    stats                         stats                 objeto_id
    suspenso_ate                  repost_info           tempo_estimado_minutos
                                  denuncias             resultado
                                  status_moderacao
...
└─────────────────────────────────────────────────────────────────────────────┘
    ...
    1. ATTRIBUTE PATTERN
       ...
       Permite: Campos opcionais/dinâmicos por documento
    ...
    2. BUCKET PATTERN
       ...
       Sem bucket, seria preciso:
       db.curtidas.count({ postagem_id: _id })  ← LENTO
    ...
    3. TTL INDEX
       ...
       Exemplo:
       Rascunho criado → 14 dias depois → Deletado automaticamente
...
module.exports = {
  info: "Este é um arquivo de documentação apenas. Ele não possui código executável."
};
